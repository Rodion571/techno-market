...
const Checkout = () => {
  const { cart, clearCart } = useCart(); // ← додано clearCart
  ...
  const handleSubmit = (e) => {
    ...
    if (name && email && address) {
      ...
      clearCart(); // ← очищення кошика після покупки
      navigate('/');
    } else {
    ...
    <div className="checkout">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="checkout-field">
          ...
          <select id="deliveryTime" value={deliveryTime} onChange={(e) => setDeliveryTime(e.target.value)} required>
        ...
        {discount > 0 && <p><span className="label">Знижка:</span> -{discount.toFixed(2)} грн</p>}
